...
{
public:
  WalletTransactionSender(const Currency& currency, WalletUserTransactionsMoonBank& transactionsMoonBank, AccountKeys keys, ITransfersContainer& transfersContainer, INode& node);
