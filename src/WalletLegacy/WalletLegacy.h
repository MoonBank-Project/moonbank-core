...
public:
  ...
  virtual void save(std::ostream& destination, bool saveDetailed = true, bool saveMoonBank = true) override;
...
private:
  ...
  void doSave(std::ostream& destination, bool saveDetailed, bool saveMoonBank);
  ...
  WalletUserTransactionsMoonBank m_transactionsMoonBank;
