...
void ge_add(ge_p1p1 *, const ge_p3 *, const ge_moonbankd *);

/* From ge_double_scalarmult.c, modified */

typedef ge_moonbankd ge_dsmp[8];
...
void ge_p3_to_moonbankd(ge_moonbankd *, const ge_p3 *);
...
void ge_sub(ge_p1p1 *, const ge_p3 *, const ge_moonbankd *);
