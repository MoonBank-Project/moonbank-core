...
namespace PaymentService
{
  ...
  void saveWallet(CryptoNote::IWallet &wallet, std::fstream &walletFile, bool saveDetailed = true, bool saveMoonBank = true)
  {
    wallet.save();
    walletFile.flush();
  }

  void secureSaveWallet(CryptoNote::IWallet &wallet, const std::string &path, bool saveDetailed = true, bool saveMoonBank = true)
  {
    ...
    try
    {
      saveWallet(wallet, tempFile, saveDetailed, saveMoonBank);
    }
    catch (std::exception &)
    {
